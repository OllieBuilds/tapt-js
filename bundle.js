...
/***/ function(module, exports, __webpack_require__) {
	...
	var tasted = __webpack_require__(8);
	var beers = __webpack_require__(29);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var removeTasted = function removeTasted(success, failure, data) {
	  console.log(data);
	  $.ajax({
	    method: 'DELETE',
	...
	var addRating = function addRating(success, failure, id, rate, data) {
	  console.log(rate);
	  $.ajax({
	    method: 'PATCH',
	...
	var sort = function sort(arr) {
	  ...
	  $('.rate').on('submit', function (event) {
	    event.preventDefault();
	    var rating = $('.tmp').val();
	    var name = $('.rate').attr('id').toString();
	    var iden = $('.tmp').attr('id').toString();
	    addRating(authUi.success, authUi.failure, iden, rating, name);
	  });
	};

	var handleBeers = function handleBeers() {
	  $.ajax({
	    method: 'GET',
	    url: app.api + 'beers'
	  }).done(function (data) {
	...
	var showTasted = function showTasted() {
	  var display = [];
	  for (var i = 0; i < app.user.beer.length; i++) {
	...
	var addTasted = function addTasted(success, failure, data) {
	  $.ajax({
	    method: 'POST',
	    url: app.api + 'tasted',
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<li>\n  <h2>"
	    ...
	    + "</p>\n  <form class=\"form rate\" role=\"rate\" id=\""
	    + alias2(alias1((depth0 != null ? depth0.name : depth0), depth0))
	    + "\">\n    <div class=\"form-group\">\n      <label>Rate This Beer:</label>\n      <input type=\"text\" id=\""
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\" class=\"form-control tmp\" placeholder=\"Rate Beers\">\n    </div>\n    <button type=\"submit\" class=\"btn btn-default rate\">Rate</button>\n  </form>\n  <button type=\"button\" class=\"btn btn-primary rmBeer\" value='"
	    + alias2(alias1((depth0 != null ? depth0.name : depth0), depth0))
	    + "'>Remove</button>\n</li>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.beer : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createBeer = function createBeer(success, failure) {
	  $.ajax({
	    method: 'POST',
	    url: app.api + 'beers',
	    data: {
	...
	var deleteBeer = function deleteBeer(success, failure, data) {
	  console.log(data);
	  // let shit = `{'id':data}`;
	  // console.log(shit);
	  $.ajax({
	...
	var searchBeers = function searchBeers(beers) {
	  var results = [];
	  var urls = [];
	  ...
	  for (var i = 0; i < beers.length; i++) {
	    if (!beers[i]['labels/medium']) {
	      ...
	      var url = beers[i]['labels/medium'].toString();
	      if (url) {
	        urls.push(url);
	      } else {
	        urls.push('null');
	  ...
	  var beersTemplate = __webpack_require__(30);
	  var labelsTemplate = __webpack_require__(31);
	  $('#beers').append(beersTemplate({ beers: results }));
	  $('#labels').append(labelsTemplate({ labels: urls }));
	  $('.remove').on('click', function (event) {
	    event.preventDefault();
	    var data = $('.remove').attr('value');
	    console.log(data);
	...
	var rename = function rename(success, failure) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<li>\n\n  "
	    + alias2(alias1((depth0 != null ? depth0.name : depth0), depth0))
	    + "\n\n</li>\n\n<button type=\"button\" class=\"btn btn-primary remove\" value='"
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "'>\n  Delete</button>\n\n  <form class=\"form rename\" role=\"rename\" id=\""
	    + alias2(alias1((depth0 != null ? depth0.name : depth0), depth0))
	    + "\">\n    <div class=\"form-group\">\n      <label>Rename:</label>\n      <input type=\"text\" id=\""
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\" class=\"form-control tmp\" placeholder=\"Rename\">\n    </div>\n    <button type=\"submit\" class=\"btn btn-default\">Rename</button>\n  </form>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var beer = __webpack_require__(29);
